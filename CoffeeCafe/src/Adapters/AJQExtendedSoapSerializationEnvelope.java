...
public class AJQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AJQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AJQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AJQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AJQDateTimeConverter dateTimeConverter = new AJQStandardDateTimeConverter();

    public AJQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AJQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AJQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AJQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AJQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AJQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
