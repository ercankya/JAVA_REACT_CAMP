...
public class AJQKPSPublicSoap
{
    ...
    public AJQKPSPublicSoap(){}

    public AJQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AJQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AJQExtendedSoapSerializationEnvelope envelope= new AJQExtendedSoapSerializationEnvelope(AJQExtendedSoapSerializationEnvelope.VER11);
