...
public class MPEKPSPublicSoap
{
    ...
    public MPEKPSPublicSoap(){}

    public MPEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MPEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MPEExtendedSoapSerializationEnvelope envelope= new MPEExtendedSoapSerializationEnvelope(MPEExtendedSoapSerializationEnvelope.VER11);
