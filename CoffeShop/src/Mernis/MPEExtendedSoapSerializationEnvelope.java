...
public class MPEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MPEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MPEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MPEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MPEDateTimeConverter dateTimeConverter = new MPEStandardDateTimeConverter();

    public MPEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MPEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MPEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MPEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MPEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MPEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
